            ...
            <div className="flex flex-col items-center h-full">
                ...
                <div className="h-4/5 flex w-full flex-col gap-2 md:h-full md:flex-wrap md:flex-row md:gap-0">
                    ...
                    <div className="order-1 h-2/6 w-full md:w-3/5 md:p-1                    transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500 ">
                        <div className=" h-full flex-col bg-white w-full text-customBlack rounded-xl p-4 text-sm text-center overflow-hidden font-bold flex items-center justify-evenly md:text-xl">
                            I CREATE BEAUTIFUL WEBSITES THAT ARE FAST LOADING FOR THE MOST PLEASANT EXPERIENCE OF THE USER.
                            <div className="hidden md:flex w-full h-1/3 flex-col justify-end items-center ">
                                <span className="w-full h-[1.5px] bg-customBlack" />
                                Front End Web Development<br />
                                <a href="https://github.com/ethangalva" target="_blank" rel="noreferrer" className="font-semibold text-sm bg-customYellow w-fit px-1 rounded-3xl mt-2">@ethangalva</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col h-2/6 gap-2 order-4 w-full md:order-2 md:w-2/5 md:p-1">
                        ...
                        <div className="order-3 md:order-2 w-full h-1/2 md:w-full md:p-0                    transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            <a href="https://realempire.vercel.app/" target="_blank" rel="noreferrer" className="h-full bg-customYellow rounded-xl flex items-center flex-row justify-between px-8 py-2">
                        ...
                        <div className="order-4 md:order-4 w-full h-1/2 md:w-full md:p-0                    transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            <a href="#projects" className="h-full bg-customGreen rounded-xl flex items-center flex-row justify-between px-8 py-2">
                                {/* dot on the left side */}
                    ...
                    <div className="order-6 hidden md:flex h-2/6 w-2/6 p-1 md:flex-col">
                        ...
                        <a href="mailto:ethangalva@gmail.com" className="flex w-full p-2 rounded-xl h-1/6 bg-customGreen text-customWhite font-bold                    transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            <p className="text-center w-full hover:underline">ethangalva@gmail.com</p>
                        </a>
                    </div>
                    ...
                    <div className="order-5 hidden md:flex h-2/6 w-4/6 p-1                    transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                        <div className="h-full w-full rounded-xl p-2 flex bg-white gap-2">
                            ...
                            <Image src="/../public/images/CuteAvataravatar.jpg" width="1000" height="1000" alt="github profile qr cod" className="w-1/2" />
                            {/* INFORMATION ABOUT ME */}
                            <div className="w-1/2 text-customBlack font-semibold flex flex-col justify-center">
