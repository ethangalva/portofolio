    ...
    return (
        <div className="h-screen flex flex-col justify-between px-8 gap-4 py-4 snap-center" id="projects">
            <div className="flex flex-col md:flex-row md:flex-wrap items-center h-full gap-2 md:gap-0 ">
                ...
                {/* PERSONAL HOBIES */}
                <div className="order-3 md:order-11 w-full h-3/6 md:p-1 md:w-3/6 gap-2 flex flex-col">
                    <div className="w-full h-full bg-white rounded-xl flex items-center py-2      hover:scale-[105%] duration-500 transition ease-in-out hover:cursor-default">
                        <h3 className="w-full font-bold text-customBlack text-center px-2 md:text-xl hover:scale-[105%] duration-500 transition ease-in-out hover:cursor-default">Some of my hobies include reading and watching articles of javascript and css libraries. Experimenting with new frameworks and technologies is something that I really enjoy. </h3>
                    </div>
                    <a className="font-bold text-2xl w-full h-2/6 bg-customGreen rounded-xl hidden md:flex px-2 text-center justify-center items-center gap-2">
                        SEND ME AN EMAIL
                ...
                <div className="order-4 md:order-2 w-full md:w-1/5 h-1/6 md:h-3/6 md:p-1">
                    <div className="w-full h-full flex flex-row md:flex-col items-center gap-2">
                        ...
                        <div className="order-2 w-1/2 h-full md:p-0 md:h-1/3 md:w-full                  transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            <a href="" className="h-full bg-customOrange hover:bg-customGray rounded-xl flex items-center flex-col text-center justify-center px-2 py-2                     transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            {/* dot on the left side */}
                        ...
                        <div className="order-3 hidden md:p-0 md:h-1/3 md:flex md:w-full                  transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            <a href="" className="h-full bg-customRed hover:bg-customGray rounded-xl flex items-center flex-col text-center justify-center px-2 py-2                     transition ease-in-out delay-250 hover:scale-[101%] origin-center duration-500">
                            {/* dot on the left side */}
                ...
                <div className="order-8 w-3/6 h-3/6 md:p-1 hidden md:flex ">
