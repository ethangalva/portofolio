    ...
    return (
        <div className="h-screen flex flex-col justify-between px-8 gap-4 py-4 snap-center" id="projects">
            <div className="flex flex-col items-center h-full gap-2">
                <div className="w-full h-1/3 py-2 px-4 flex flex-col justify-between bg-customOrange rounded-xl text-customBlack                  transition ease-in-out delay-100 hover:scale-[101%] hover:bg-customYellowLight origin-center duration-500">
                ...
                <div className="w-full h-1/3 py-2 px-4 flex flex-col justify-between bg-customOrange rounded-xl text-customBlack                  transition ease-in-out delay-100 hover:scale-[101%] hover:bg-customYellowLight origin-center duration-500">
                    {/* TITLE AND SHORT DESCRIPTION OF PROJECT */}
                    <div className="h-1/2">
                        <h3 className="text-center font-bold text-lg ">TateBud</h3>
                        <div className="font-semibold text-center">Web aplication that finds recipes and their nutritional values</div>
                    </div>
                    {/* PROJECTS LINKS AND SEE MORE */}
                    <div className="flex flex-col gap-2">
                        {/* see more */}
