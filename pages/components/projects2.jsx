        ...
        <div className="h-screen flex flex-col justify-between px-8 py-4 snap-center" id="projects">
            <div className="flex flex-col flex-nowrap h-full relative gap-0 overflow-hidden">
                ...
                <div className={isProjectOpen4 ? "w-full h-1/2 p-1   project active" : "w-full h-1/2 p-1   project"}>
                    <div className={isProjectOpen3 ? "hidden" : "md:flex-row md:flex-wrap md:w-full w-full h-full p-2 flex flex-col justify-between rounded-xl text-customBlack bg-customPurple hover:bg-customGray transition ease-in-out duration-500"}>
                        {/* TITLE AND SHORT DESCRIPTION OF PROJECT */}
